...
#bash start_program.sh datasets/train/images datasets/out "Augmentation 4" 1.2 /home/nikolavlaskalin/Desktop/ADOS_PZ1_Labeling_and_Augmentation/datasets/train/labels 4 3 175 3
